...
export function ChatPanel({ fullscreen = false }) {
  ...
  return (
    <div className="flex flex-col h-full rounded-xl overflow-hidden border" style={{ height: 'calc(100dvh - 14rem)', minHeight: '320px', background:'#0b0e14', borderColor:'#0b0e14' }}>
      {/* Engine selector */}
